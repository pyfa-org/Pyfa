...
class StatsPane(wx.Panel):
    ...
    def fitChanged(self, event):
        ...
        statsMiniFull = (("label%sUsedTurretHardpoints", lambda: fit.getHardpointsUsed(Hardpoint.TURRET), 0, 0, 0),
                         ...
                         ("label%sUsedPg", lambda: fit.pgUsed, 3, 0, 9),
                         ("label%sUsedCpu", lambda: fit.cpuUsed, 3, 0, 9),
                         ("label%sTotalPg", lambda: fit.ship.getModifiedItemAttr("powerOutput"), 3, 0, 9),
                         ("label%sTotalCpu", lambda: fit.ship.getModifiedItemAttr("cpuOutput"), 3, 0, 9),
