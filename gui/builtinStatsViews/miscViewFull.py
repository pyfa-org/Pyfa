...
class MiscViewFull(StatsView):
    ...
    def populatePanel(self, contentPanel, headerPanel):
        ...
        image = BitmapLoader.getBitmap("ship_small", "gui")
        self.shipstats = wx.BitmapButton(contentPanel, -1, image)
        self.shipstats.SetToolTip(wx.ToolTip("Click to toggle to Ship View"))
        self.shipstats.Bind(wx.EVT_BUTTON, self.switchToShipStatsViewFull)
        hsizer.Add(self.shipstats, 0, wx.ALIGN_TOP)
        ...
        hsizer.Add(self.miningyield, 0, wx.ALIGN_TOP)

        image = BitmapLoader.getBitmap("totalPrice_small", "gui")
        self.price = wx.BitmapButton(contentPanel, -1, image)
        self.price.SetToolTip(wx.ToolTip("Click to toggle to Price View"))
        self.price.Bind(wx.EVT_BUTTON, self.switchToPriceViewFull)
        hsizer.Add(self.price, 0, wx.ALIGN_TOP)

        image = BitmapLoader.getBitmap("drone_small", "gui")
        self.price = wx.BitmapButton(contentPanel, -1, image)
        self.price.SetToolTip(wx.ToolTip("Click to toggle to Drone View"))
        self.price.Bind(wx.EVT_BUTTON, self.switchToShipStatsViewFull)
        hsizer.Add(self.price, 0, wx.ALIGN_TOP)
        ...
        #hsizer = self.buttonPanel.GetSizer()
        #self.stEff = wx.StaticText(self.headerPanel, wx.ID_ANY, "( Effective )")
        #hsizer.Add(self.stEff)
        #self.headerPanel.GetParent().AddToggleItem(self.stEff)
        ...
        self.miningyield = wx.BitmapButton(contentPanel, -1, image)
        self.miningyield.SetToolTip(wx.ToolTip("Click to toggle to Mining Yield "))
        self.miningyield.Bind(wx.EVT_BUTTON, self.switchToShipStatsViewFull)
        sizerFirepower.Add(self.miningyield, 0, wx.ALIGN_CENTER)
        ...
        image = BitmapLoader.getBitmap("mining_small", "gui")
        self.price = wx.BitmapButton(contentPanel, -1, image)
        self.price.SetToolTip(wx.ToolTip("Click to toggle to Mining Yield "))
        self.price.Bind(wx.EVT_BUTTON, self.switchToMiningYieldView)
        sizerFirepower.Add(self.price, 0, wx.ALIGN_LEFT)
        '''
    ...
    def switchToPriceViewFull(self, event):
        # Getting the active fit
        mainFrame = gui.mainFrame.MainFrame.getInstance()
        sFit = service.Fit.getInstance()
        fit = sFit.getFit(mainFrame.getActiveFit())
        ...
        # Get the new view
        view = StatsView.getView("priceViewFull")(self.parent)
        view.populatePanel(self.panel, self.headerPanel)
        # Populate us in statsPane's view list
        self.parent.views.append(view)
        # Get the TogglePanel
    ...
    def switchToShipStatsViewFull(self, event):
        # Getting the active fit
        mainFrame = gui.mainFrame.MainFrame.getInstance()
        sFit = service.Fit.getInstance()
        fit = sFit.getFit(mainFrame.getActiveFit())
        ...
        # Get the new view
        view = StatsView.getView("shipStatsViewFull")(self.parent)
        view.populatePanel(self.panel, self.headerPanel)
        # Populate us in statsPane's view list
        self.parent.views.append(view)
        # Get the TogglePanel
