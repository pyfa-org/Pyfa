...
class PFMarketPref(PreferenceView):
    ...
    def populatePanel(self, panel):
        ...
        totalPricePanel = self.tbTotalPriceBox.GetStaticBox()
        self.tbTotalPriceDrones = wx.CheckBox(totalPricePanel, -1, _t("Drones"), wx.DefaultPosition, wx.DefaultSize, 1)
        ...
        self.tbTotalPriceCargo = wx.CheckBox(totalPricePanel, -1, _t("Cargo"), wx.DefaultPosition, wx.DefaultSize, 1)
        ...
        self.tbTotalPriceCharacter = wx.CheckBox(totalPricePanel, -1, _t("Implants && Boosters"), wx.DefaultPosition, wx.DefaultSize, 1)
