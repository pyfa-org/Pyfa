...
def handler(fit, module, context):
    ...
    if damagePattern:
        ...
        damagePattern_tuple.append(['Thermal',
                                    ...
                                    damagePattern.thermalAmount * fit.ship.getModifiedItemAttr(
        ...
        damagePattern_tuple.append(['Kinetic',
                                    ...
                                    damagePattern.kineticAmount * fit.ship.getModifiedItemAttr(
        ...
        damagePattern_tuple.append(['Explosive',
                                    ...
                                    damagePattern.explosiveAmount * fit.ship.getModifiedItemAttr(
        ...
        while runLoop == 1:
            ...
            if damagePattern.emAmount == \
                ...
                damagePattern_tuple[3][4] -= vampDmg
                ...
                for i in [2, 3]:
                    attr = "armor%sDamageResonance" % damagePattern_tuple[i][0].capitalize()
                    damagePattern_tuple[i][4] -= vampDmgTotal
                ...
                if damagePattern_tuple[1][4] == 1 == damagePattern_tuple[0][4]:
                    ...
                    break
                elif ((1 - damagePattern_tuple[0][4]) < resistanceShiftAmount and
                        (1 - damagePattern_tuple[1][4]) < resistanceShiftAmount) and \
                        (countPasses > 10):
                    logger.debug(
