...
def handler(fit, module, context):
    ...
    if damagePattern:
        ...
        RAHResistance = [
            module.itemModifiedAttributes.getOriginal('armorEmDamageResonance'), 
            module.itemModifiedAttributes.getOriginal('armorThermalDamageResonance'), 
            module.itemModifiedAttributes.getOriginal('armorKineticDamageResonance'), 
            module.itemModifiedAttributes.getOriginal('armorExplosiveDamageResonance'),
        ]
        ...
        for cycle in loopCycles:
            for i in range(4):
                average[i] += cycle[i] / len(loopCycles)
