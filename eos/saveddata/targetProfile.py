...
BUILTINS = OrderedDict([
    ...
    (-40, (_c(_t('NPC')) + _c(_t('Burner')) + _t('Cruor (Blood Raiders)'), 0.795, 0.734, 0.693, 0.672, 900, 18, 20.5)),
    (-41, (_c(_t('NPC')) + _c(_t('Burner')) + _t('Dramiel (Angel)'), 0.351, 0.481, 0.611, 0.676, 2100, 11, 25)),
    (-42, (_c(_t('NPC')) + _c(_t('Burner')) + _t('Daredevil (Serpentis)'), 0.685, 0.59, 0.59, 0.433, 1200, 18, 25)),
    (-43, (_c(_t('NPC')) + _c(_t('Burner')) + _t('Succubus (Sanshas Nation)'), 0.351, 0.481, 0.611, 0.676, 4750, 30, 59)),
    (-44, (_c(_t('NPC')) + _c(_t('Burner')) + _t('Worm (Guristas)'), 0.475, 0.58, 0.685, 0.738, 360, 70, 39)),
