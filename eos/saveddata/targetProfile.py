...
BUILTINS = OrderedDict([
    ...
    (-92, ('[NPC][Abyssal][Firestorm T3 (Some T5)]Drones', 0.461, 0.36, 0.541, 0.443)),
    (-93, ('[NPC][Abyssal][Firestorm T3 (Some T5)]Overmind', 0.666, 0.413, 0.634, 0.646)),
    (-94, ('[NPC][Abyssal][Firestorm T3 (Some T5)]Seeker', 0.084, 0, 0.084, 0.084)),
    (-95, ('[NPC][Abyssal][Firestorm T3 (Some T5)]Triglavian', 0.537, 0.166, 0.489, 0.371)),
    (-96, ('[NPC][Abyssal][Firestorm T3 (Some T5)]Drifter', 0.43, 0.201, 0.43, 0.43)),
    (-97, ('[NPC][Abyssal][Firestorm T3 (Some T5)]Sleeper', 0.512, 0.337, 0.512, 0.512)),
    (-98, ('[NPC][Abyssal][Firestorm T3 (Some T5)]All', 0.537, 0.269, 0.512, 0.495)),
    ...
    # Source: ticket #2265
    (-148, ('[NPC][Abyssal][Dark Matter All Tiers]Concord', 0.301, 0.298, 0.309, 0.337)),
    ...
    (-151, ('[NPC][Abyssal][Electrical T0/T1/T2]Concord', 0.096, 0.298, 0.309, 0.337)),
    ...
    (-154, ('[NPC][Abyssal][Electrical T3 (Some T5 Rooms)]Concord', 0.014, 0.298, 0.309, 0.337)),
    ...
    (-157, ('[NPC][Abyssal][Electrical T4/T5/T6]Concord', 0.01, 0.298, 0.309, 0.337)),
    ...
    (-160, ('[NPC][Abyssal][Firestorm T0/T1/T2]Concord', 0.316, 0.109, 0.317, 0.328)),
    ...
    (-163, ('[NPC][Abyssal][Firestorm T3 (Some T5 Rooms)]Concord', 0.316, 0.024, 0.317, 0.328)),
    (-164, ('[NPC][Abyssal][Firestorm T3 (Some T5)]Sansha', 0.148, 0.14, 0.329, 0.328)),
    (-165, ('[NPC][Abyssal][Firestorm T3 (Some T5)]Angel', 0.587, 0.241, 0.439, 0.39)),
    (-166, ('[NPC][Abyssal][Firestorm T4/T5/T6]Concord', 0.316, 0.016, 0.317, 0.328)),
    ...
    (-169, ('[NPC][Abyssal][Exotic T0/T1/T2]Concord', 0.301, 0.298, 0.102, 0.337)),
    ...
    (-172, ('[NPC][Abyssal][Exotic T3 (Some T5 Rooms)]Concord', 0.301, 0.298, 0.009, 0.337)),
    ...
    (-175, ('[NPC][Abyssal][Exotic T4/T5/T6]Concord', 0.301, 0.298, 0.005, 0.337)),
    ...
    (-178, ('[NPC][Abyssal][Gamma T0/T1/T2]Concord', 0.296, 0.293, 0.308, 0.149)),
    (-179, ('[NPC][Abyssal][Gamma T0/T1/T2]Sansha', 0.137, 0.355, 0.352, 0.16)),
    (-180, ('[NPC][Abyssal][Gamma T0/T1/T2]Angel', 0.59, 0.528, 0.477, 0.286)),
    (-181, ('[NPC][Abyssal][Gamma T3 (Some T5 Rooms)]Concord', 0.296, 0.293, 0.308, 0.054)),
    ...
    (-184, ('[NPC][Abyssal][Gamma T4/T5/T6]Concord', 0.296, 0.293, 0.308, 0.029)),
