...
BUILTINS = OrderedDict([
    ...
    (-113, (_c(_t('Condenser Packs')) + _t('BlastShot'), 232, 0, 756, 0)),
    (-114, (_c(_t('Condenser Packs')) + _t('GalvaSurge'), 756, 0, 231, 0)),
    (-115, (_c(_t('Condenser Packs')) + _t('MesmerFlux'), 359, 0, 135, 0)),
    (-116, (_c(_t('Condenser Packs')) + _t('SlamBolt'), 132, 0, 359, 0)),
    (-117, (_c(_t('Condenser Packs')) + _t('[t2] ElectroPunch'), 595, 0, 591, 0)),
    (-118, (_c(_t('Condenser Packs')) + _t('[t2] StrikeSnipe'), 325, 0, 321, 0)),
    ...
    (-68, (_c(_t('NPC')) + _c(_t('Burner')) + _t('Cruor'), 90, 90, 0, 0)),
    (-69, (_c(_t('NPC')) + _c(_t('Burner')) + _t('Dramiel'), 55, 0, 20, 96)),
    (-70, (_c(_t('NPC')) + _c(_t('Burner')) + _t('Daredevil'), 0, 110, 154, 0)),
    (-71, (_c(_t('NPC')) + _c(_t('Burner')) + _t('Succubus'), 135, 30, 0, 0)),
    (-72, (_c(_t('NPC')) + _c(_t('Burner')) + _t('Worm'), 0, 0, 228, 0)),
    ...
    (-77, (_c(_t('NPC')) + _c(_t('Burner')) + _t('Ashimmu'), 260, 100, 0, 0)),
    (-78, (_c(_t('NPC')) + _c(_t('Burner')) + _t('Talos'), 0, 413, 413, 0)),
    (-79, (_c(_t('NPC')) + _c(_t('Burner')) + _t('Sentinel'), 0, 0, 75, 90)),
